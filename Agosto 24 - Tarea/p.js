...
// PROMEDIO
function llamados(c1, c2, c3, c4, c5, c6) {

    var p = c1()
    setTimeout(() => {
    console.log("El promedio de precios es: ", p)
    }, 1500);
    setTimeout(() => {
        console.log("Los números menos el promedio son: ")
        c2(p)
    }, 2000);

   setTimeout(() => {
    console.log("Y estos numeros potenciados son: ")
    c3()
   }, 3000);
    
   setTimeout(() => {
    console.log("La suma de los numeros potenciados es de: " )
    c4()
   }, 4000);
    setTimeout(() => {
        c5()
    console.log("La division entre la suma y la cantidad menos uno es: ")
    }, 5000);
    setTimeout(() => {
        c6()
    console.log("La desviación estandar de inventario es: ")
    }, 6000);
...
var prom1 = suma / Inventario.length
return prom1
}
...
console.log("")
llamados(promedio, numMenosPro, numPotenciados, sumarNumPot, divisionSumCan, resultadoDesviacion)
